<template>
  <div class="news" v-loading.fullscreen.lock="fullscreenLoading">
      ...
      <sui-grid class="ui padded horizontally vertically">
        <sui-grid-column :width="12">
          <sui-item-group divided>
            <sui-item v-for="i in this.news" :key="i.news_id">


              <sui-item-content>
                <sui-item-header>
                  <router-link :to="'news/'+i.news_id"
                               style="color: #212121"
                  >
                    {{i.title}}
                  </router-link>
                ...
                <sui-item-extra class="ui end floated">
                  ...
                  <span class="ui  right floated">评论数：{{i.comment | commentNum  }}</span>
